function hist4ProtocolsDepths(Depth1, Depth2, n_bins, sp, blockEvents, recParams, sec_before_trigger, type_sequence)
%
...
% of spikes in all trials between such specified depths.
%
% Inputs
...
for i=1:4
    ...
    if ISI_33(i)
        ...
        max_value = histSummedDepths(soi_trials.spTimes, soi_trials.spDepths, Depth1, Depth2, n_bins, recParams, idx_chosen, sec_before_trigger, type_sequence, color);
